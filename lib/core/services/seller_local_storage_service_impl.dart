...
class SellerLocalStorageServiceImpl implements SellerLocalStorageService {
  ...
  // When seller logs in, make sure to save data properly:
  @override
  Future<void> saveSellerData(Map<String, dynamic> sellerData) async {
    print('💾 Saving seller data: ${sellerData.keys.toList()}');
    print('   Seller ID: ${sellerData['_id']}');
    print('   Seller Name: ${sellerData['fullName']}');

    // Convert Map to JSON string
    final jsonString = jsonEncode(sellerData);
    await _prefs.setString(_sellerDataKey, jsonString);
    print('✅ Seller data saved');
  }
