...
/// Ads Statistics Bar Widget
class AdsStatisticsBar extends StatelessWidget {
  final SellerAdProvider provider;

  const AdsStatisticsBar({super.key, required this.provider});
...
/// Ads Filter Bar Widget
class AdsFilterBar extends StatelessWidget {
  final SellerAdProvider provider;

  const AdsFilterBar({super.key, required this.provider});
...
class AdsCard extends StatelessWidget {
  ...
  void _showAdDetails(BuildContext context, SellerAdModel ad) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => AdDetailsSheet(ad: ad),
    );
  }

  void _editAd(BuildContext context, SellerAdModel ad) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CreateAdScreen(ad: ad)),
    );
  }

  void _deleteAd(BuildContext context, SellerAdModel ad) {
    showDialog(
      context: context,
...
/// Ad Details Bottom Sheet
class AdDetailsSheet extends StatelessWidget {
  final SellerAdModel ad;

  const AdDetailsSheet({super.key, required this.ad});
...
class AdsEmptyState extends StatelessWidget {
  ...
  const AdsEmptyState({super.key, required this.statusFilter, this.onViewAll});
...
/// Error State Widget
class AdsErrorState extends StatelessWidget {
