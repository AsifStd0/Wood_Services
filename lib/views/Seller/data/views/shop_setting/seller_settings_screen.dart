...
class _SellerSettingsScreenState extends State<SellerSettingsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Load actual seller data from signup
      context.read<ShopSettingsViewModel>().loadSellerDataFromSignup();
    });
  }
...
class _ShopSettingsContent extends StatelessWidget {
      ...
      builder: (context, viewModel, child) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Shop Header with Actual Signup Data
              _buildShopHeader(viewModel),

              const SizedBox(height: 24),

              // Shop Banner from Signup
              ...
              // Shop Branding from Signup
              _buildShopBrandingSection(viewModel),

              const SizedBox(height: 24),

              // Categories from Signup
              _buildCategoriesSection(viewModel, context),

              const SizedBox(height: 24),

              // Bank Details from Signup
  ...
  Widget _buildNoDataState(ShopSettingsViewModel viewModel) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(20),
        child: Column(
          ...
          children: [
            ...
            Text(
              'Complete your seller registration to set up your shop',
  ...
  Widget _buildPersonalInfoSection(ShopSettingsViewModel viewModel) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildBusinessInfoSection(ShopSettingsViewModel viewModel) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildShopBrandingSection(ShopSettingsViewModel viewModel) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildBankDetailsSection(ShopSettingsViewModel viewModel) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          // Show uploaded documents from signup
          ...
          const SizedBox(height: 16),
          if (viewModel.isEditing) _buildUploadDocumentsButton(viewModel),
        ],
      ),
    );
  }
  ...
  Widget _buildUploadDocumentsButton(ShopSettingsViewModel viewModel) {
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        onPressed: () => _handleDocumentUpload(viewModel),
        style: OutlinedButton.styleFrom(
  ...
  // Action handlers
  void _handleLogoUpload(ShopSettingsViewModel viewModel) {
    // Implement image picker for logo
    // viewModel.pickShopLogo();
  }

  void _handleBannerUpload(ShopSettingsViewModel viewModel) {
    // Implement image picker for banner
  ...
  void _previewShop(BuildContext context) {
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Opening shop preview...')));
  }
}
// // views/shop_settings_screen.dart
// import 'package:flutter/material.dart';
